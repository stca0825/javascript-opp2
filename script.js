...
console.log(shoutText("Dette er kult"));
console.log(shoutText("dette er stress når timelimit er under 6 timer"));
...
function greetUser(name, hour) {
  if (hour === undefined) {
    return "Error: No hour value was provided";
  }
...
console.log(greetUser("Joe", 3));
console.log(greetUser("Camilla", 8));
console.log(greetUser("Johannes", 16));
console.log(greetUser("Steffen", 19));
console.log(greetUser("Mia", 23));
...
console.log(removeFirstAndLast(["Red", "Green", "Blue", "Purple"]));
console.log(removeFirstAndLast(["One", "Two", "Three", "Four", "Five", "Six"]));
console.log(removeFirstAndLast(["OnlyOne"]));
...
function updateString(text) {
  ...
  let updated = trimmed.replace("difficult", "fun");

  return updated;
}

console.log(updateString(" Javascript is difficult "));

console.log(updateString(" It is difficult to use methods "));

console.log(updateString("difficult"));
